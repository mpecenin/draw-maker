(function (owner) {
    ...
    - criar sample visualize, com upload de imagem e botão para abrir drawmaker.
    ...
    */
    ...
    ns.CircleMaker = class extends ns.BaseMaker {
        ...
        update(options) {
            let pointer = this.dm.canvas.getPointer(options.e);
            let width = this.roundFloat((pointer.x - this._startLeft) / 2.0);
            let height = this.roundFloat((pointer.y - this._startTop) / 2.0);
